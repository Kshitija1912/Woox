...
<%@page import="com.example.demo.bean.images"%>
        ...
        <div class="slider-content">
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <% List<images> img=(List)request.getAttribute("images");
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          ...
          <%List<offers> offers=(List)request.getAttribute("offers");
          for(offers of:offers){%>
      			
            <div class="item">
              <div class="thumb">
                <img src="<%=of.getImage() %>" alt="">
                <div class="text">
                  <h4><%=of.getImagename()%><br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
                  ...
                  <div class="main-button">
					<%if(r!=null){%>
						<a href="adddest?image=<%=of.getImage()%>&imagename=<%=of.getImagename()%>&price=<%=of.getPrice()%>">Make a Reservation</a>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="main-button text-center">
            <a href="deals">Discover All Places</a>
          </div>
        </div>
      </div>
    </div>
